...
> 2025-11-11 로컬 카메라 모드 통합 요약을 보존한 문서입니다. 아래 체크리스트·설정 예시·예상 로그는 당시 기록이며 현재 검증 완료 상태를 뜻하지 않습니다. 현재 적용 범위와 설정 제약은 [검증기 가이드](docs/VALIDATOR_INTEGRATION_GUIDE.md), 서버 실행과 테스트는 [README](README.md)를 참고하세요.
